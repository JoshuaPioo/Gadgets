    ...
    <nav className="backdrop-blur-lg bg-white/60 shadow-md fixed top-0 left-0 w-full z-50">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 text-gray-700 font-medium">
          ...
          <Link to="/profile" className="hover:text-pink-600 transition flex items-center gap-1">
            <FiUser /> Profile
          </Link>
      ...
      {open && (
        <div className="md:hidden bg-white/90 backdrop-blur-lg shadow-md px-6 py-4 flex flex-col gap-4 text-gray-700 font-medium">
          <Link onClick={() => setOpen(false)} to="/" className="hover:text-pink-600 transition">Home</Link>
          <Link onClick={() => setOpen(false)} to="/products" className="hover:text-pink-600 transition">Products</Link>
